...
const EditService = ({
  ...
  useEffect(() => {
    ...
    const url =
      "https://hackathon2-crm-backend.herokuapp.com/api/managerdashboard/servicerequest";
  ...
  const editServiceRequest = () => {
    ...
    axios
      .put(
        `https://hackathon2-crm-backend.herokuapp.com/api/managerdashboard/servicerequest/${id}`,
        response
      )
      .then((res) => {
